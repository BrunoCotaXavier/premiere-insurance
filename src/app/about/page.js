        ...
        <div>
            <div className="relative">
                ...
                <div className="flex flex-col items-center justify-center relative z-10 sm:pt-20 pt-10">
                    <h1 className="text-40 text-white text-center text-with-shadow">BOSTON PREMIERE INSURANCE  </h1>
            ...
            <div className="w-full p-10 flex sm:pl-40 sm:pr-40 flex pb-10 flex sm:flex-row flex-col">
                <div className="sm:w-1/2 pb-10">
                    ...
                    <div className="flex w-full justify-start">
                        ...
                        <p className="p-1 text-15 primary-color">contact@PremiereInsurance.com</p>
                    </div>
                    <div className="flex w-full justify-start">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div className="w-full flex sm:justify-end justify-center">
                    <iframe
                        ...
                        height={300}
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2945.5403035207455!2d-71.68787992388776!3d42.41623297118777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e3f148eae82f47%3A0x947a1fd337959492!2sPremiere%20Advisors%2C%20Inc%20-%20Premiere%20Broker%2C%20Inc!5e0!3m2!1sen!2sbr!4v1716908212750!5m2!1sen!2sbr"
                        allowfullscreen=""
                        loading="lazy"
